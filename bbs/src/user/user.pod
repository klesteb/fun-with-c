...
This class implements the user database. It is an extension of the rms
class. Records that are deleted are not removed from the database. They 
...
=head2 I<rms_t *user_create(NULL)>

This method initializes the class. 

=head2 I<int user_destroy(rms_t *self)>
...
=head2 I<int user_override(rms_t *self, item_list_t *items)>
...
=head2 I<int user_compare(rms_t *this, rms_t *that)>
...
=head2 I<char *user_version(rms_t *self)>
...
=head2 I<int user_open(rms_t *self)>
...
=head2 I<int user_close(rms_t *self)>
...
=head2 I<int user_add(rms_t *self, user_base_t *user)>
...
=head2 I<int user_del(rms_t *self, int index)>
...
=head2 I<int user_get(rms_t *self, int index, user_base_t *user)>
...
=head2 I<int user_put(rms_t *self, int index, user_base_t *user)>
...
=head2 I<int user_find(rms_t *self, void *data, int len, int (*compare)(void *, int, user_base_t *), off_t *index)>
...
=head2 I<int user_search(rms_t *self, void *data, int len, int (*compare)(void *, int, user_base_t *), int (*capture)(rms_t *, user_base_t *, queue *), queue *)>
