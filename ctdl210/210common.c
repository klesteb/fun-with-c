...
unsigned short thisSector = 0;
unsigned char  catChar = 0;
unsigned short catSector = 0;
unsigned short oldestLo = 0;
unsigned short oldestHi = 0;
unsigned short newestLo = 0;
unsigned short newestHi = 0;
int maxMSector = 1;
