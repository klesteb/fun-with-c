...
=head2 I<rms_t *user_create(char *path, int records, int retries, int timeout, tracer_t *dump)>
...
=head2 I<int user_find(rms_t *self, void *data, int len, int (*compare)(void *, int, user_base_t *), off_t *recnum)>
...
=head2 I<int user_search(rms_t *self, void *data, int len, int (*compare)(void *, int, user_base_t *), int (*capture)(rms_t *, void *, queue *), queue *)>
...
=head2 I<int user_capture(rms_t *self, void *data, queue *results)>
