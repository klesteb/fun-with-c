...
=head2 I<door_t *door_create(NULL)>

This method initializes the class. 

=head2 I<int door_destroy(door_t *self)>
...
=head2 I<int door_override(door_t *self, item_list_t *items)>
...
=head2 I<int door_compare(door_t *this, door_t *that)>
...
=head2 I<char *door_version(door_t *self)>
