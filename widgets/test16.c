...
#include "widgets/windows/list_menu.h"
...
int build_menu(error_trace_t *errors) {
    ...
    when_error_in {
        ...
        SET_MENU(list[6], "test 7", "this is test 7", MENUS_T_SEPERATOR, data7, strlen(data7), print_result);
        ...
        bmenu = list_menu(startx, starty, height, width, print_description, list, sizeof(list));
